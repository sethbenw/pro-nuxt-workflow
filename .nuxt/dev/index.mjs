globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, getQuery as getQuery$1, createError } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/radix3/dist/index.mjs';
import { defineNitroPlugin } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/nitropack/dist/runtime/plugin.mjs';
import { packString } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/packrup/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/node_modules/pathe/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\seth.weingarten\\Documents\\vue-mastery\\pro-nuxt-workflow","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\seth.weingarten\\Documents\\vue-mastery\\pro-nuxt-workflow\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\seth.weingarten\\Documents\\vue-mastery\\pro-nuxt-workflow\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\seth.weingarten\\Documents\\vue-mastery\\pro-nuxt-workflow\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _guvhWoF0xz = defineNitroPlugin((nitro) => {
...
const _O3fRMu = lazyEventHandler(() => {
...
const getClientManifest = () => import('file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/seth.weingarten/Documents/vue-mastery/pro-nuxt-workflow/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
